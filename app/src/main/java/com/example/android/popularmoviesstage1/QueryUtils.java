    ...
    public static ArrayList<Movie> extractMovie(String jsonResponse) {
        ...
        try {
            ...
            for ( int i = 0 ; i < results.length() ; i++ ){
                ...
                String original_language = currentResult.optString("original_language");
                String title = currentResult.optString("title");
                String backdrop_path = currentResult.optString("backdrop_path");
                Double popularity = currentResult.optDouble("popularity");
                int vote_count = currentResult.optInt("vote_count");
                Boolean video = currentResult.optBoolean("video");
